...
#1
$db = new FileDB(array('var1', 'var2', 'var3'));
...
#7
$db = new FileDB(array('name', 'body', 'date'));
...
#8
$db = new FileDB(array('text1', 'text2'));
